	...
	Self::IntVec3Type: IntVec3<Scalar = Self::Scalar>,
{
	...
	fn extend(self, v: Self::Scalar) -> Self::IntVec3Type;
}

impl IntVec2 for glam::I16Vec2 {
	type Scalar = i16;
	...
	fn extend(self, v: Self::Scalar) -> Self::IntVec3Type { self.extend(v) }
}

impl IntVec2 for glam::U16Vec2 {
	type Scalar = u16;
