...
where
	for <'a> Self:
		...
		From<(Self::IntVec2Type, Self::Scalar)> +
	,
	Self::Scalar:
		...
		PrimInt +
	,
	Self::IntVec2Type: IntVec2<Scalar = Self::Scalar>,
	Self::IntVec4Type: IntVec4<Scalar = Self::Scalar>,
{
	type Scalar;
	type IntVec2Type;
	type IntVec4Type;
	...
	fn extend(self, v: Self::Scalar) -> Self::IntVec4Type;
	fn truncate(self) -> Self::IntVec2Type;
	fn cross(self, rhs: Self) -> Self;
}

impl IntVec3 for glam::I16Vec3 {
	type Scalar = i16;
	type IntVec2Type = glam::I16Vec2;
	type IntVec4Type = glam::I16Vec4;
	...
	fn extend(self, v: Self::Scalar) -> Self::IntVec4Type { self.extend(v) }
	fn truncate(self) -> Self::IntVec2Type { self.truncate() }
	fn cross(self, rhs: Self) -> Self { self.cross(rhs) }
}

impl IntVec3 for glam::U16Vec3 {
	type Scalar = u16;
	type IntVec2Type = glam::U16Vec2;
	type IntVec4Type = glam::U16Vec4;
	const ZERO: Self = Self::ZERO;
	const ONE: Self = Self::ONE;
	const MIN: Self = Self::MIN;
	const MAX: Self = Self::MAX;
...
impl IntVec3 for glam::IVec3 {
	type Scalar = i32;
	type IntVec2Type = glam::IVec2;
	type IntVec4Type = glam::IVec4;
	const ZERO: Self = Self::ZERO;
	const ONE: Self = Self::ONE;
	const MIN: Self = Self::MIN;
	const MAX: Self = Self::MAX;
...
impl IntVec3 for glam::UVec3 {
	type Scalar = u32;
	type IntVec2Type = glam::UVec2;
	type IntVec4Type = glam::UVec4;
	const ZERO: Self = Self::ZERO;
	const ONE: Self = Self::ONE;
	const MIN: Self = Self::MIN;
	const MAX: Self = Self::MAX;
...
impl IntVec3 for glam::I64Vec3 {
	type Scalar = i64;
	type IntVec2Type = glam::I64Vec2;
	type IntVec4Type = glam::I64Vec4;
	const ZERO: Self = Self::ZERO;
	const ONE: Self = Self::ONE;
	const MIN: Self = Self::MIN;
	const MAX: Self = Self::MAX;
...
impl IntVec3 for glam::U64Vec3 {
	type Scalar = u64;
	type IntVec2Type = glam::U64Vec2;
	type IntVec4Type = glam::U64Vec4;
	const ZERO: Self = Self::ZERO;
	const ONE: Self = Self::ONE;
	const MIN: Self = Self::MIN;
	const MAX: Self = Self::MAX;
