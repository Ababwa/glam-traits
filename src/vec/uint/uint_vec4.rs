...
where
	for <'a> Self:
		...
		From<(Self::UIntVec3Type, Self::Scalar)> +
	,
	Self::Scalar:
		Div<Self> +
		Mul<Self> +
	...
	Self::UIntVec3Type: UIntVec3<Scalar = Self::Scalar>,
{
	...
	fn truncate(self) -> Self::UIntVec3Type;
}

impl UIntVec4 for glam::U16Vec4 {
	type Scalar = u16;
	...
	fn truncate(self) -> Self::UIntVec3Type { self.truncate() }
}

impl UIntVec4 for glam::UVec4 {
	type Scalar = u32;
	type BVec4Type = glam::BVec4;
...
impl UIntVec4 for glam::U64Vec4 {
	type Scalar = u64;
	type BVec4Type = glam::BVec4;
